...
class Banners{
	...
	public function __construct(){
		global $_web;
		$this->lang        = $_web['lang'];
		$this->pages     = new system\Model($this->lang.'_banner_images');
	}
	...
	public function getPagiPages($start,$limit){
		...
		$this->pages->join('user', 'user.id = '.$this->lang.'_banner_images.author_create', 'LEFT');
	...
	public function findSearch($search){
		$select = $this->lang."_banner_images.*, user.id as id_user, user.username";
		$this->pages->where($this->lang.'_banner_images.title', '%'.$search.'%', 'like');
		$this->pages->join('user', 'user.id = '.$this->lang.'_banner_images.author_create', 'LEFT');
