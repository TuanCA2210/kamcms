                        ...
                        <div class="col-md-6">
                              ...
                              <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                  ...
                                  <div class="col-md-12 sidebar-box text-right">
                                      <div class="form-group">
                                          ...
                                          $stt = 1;
                                           foreach ($this->data['data_info_order']['product'] as $key => $value) { ?>
                                                   <tr>
                                                      <td><?php echo $stt++;?></td>
                                                      <td>
                                                          <img src="<?php echo (isset($value['image']) && $value['image']!='') ? base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url().'tmp/cdn/'.$value['image'].'&h=80&w=100&zc=2' : base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url().'tmp/public/images/img.png&h=80&w=100&zc=2'; ?>" width="100" height="80" class="img-thumbnail"/>
                                                      </td>
