...
class HomeController extends Controller{
	...
	public function __construct(){
		...
		$this->fileJson = $this->returnFiles('client_secret_916949212857-l1racku3pi9585qptafu9b03vv0feman.apps.googleusercontent.com.json');
		$this->callback = 'http://' . $_SERVER['HTTP_HOST'] . '/cadmin/home/home/oauth2callback';
	}
	...
	public function oauth2callback(){
		...
		if (! isset($_GET['code'])) {
		  ...
		  $redirect_uri = 'http://' . $_SERVER['HTTP_HOST'] . '/cadmin/home/home/index';
		  header('Location: ' . filter_var($redirect_uri, FILTER_SANITIZE_URL));
		}
