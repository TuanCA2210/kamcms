        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <p><?php echo lang('uniquevisitors'); ?></p>
            </div>
            <div class="icon">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="#revenue-chart" data-toggle="tab"><?php echo lang('topbrowse'); ?></a></li>
              <li><a href="#sales-chart" data-toggle="tab"><?php echo lang('topvisit'); ?></a></li>
              <li class="pull-left header"><i class="fa fa-line-chart" aria-hidden="true"></i> <?php echo lang('trafficdetails'); ?></li>
            </ul>
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="box box-solid bg-teal-gradient">
            <div class="box-header">
              ...
              <h3 class="box-title"> <?php echo lang('trafficdashboard'); ?></h3>
