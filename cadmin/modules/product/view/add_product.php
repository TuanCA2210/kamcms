			            ...
			            <div class="tab-pane active" id="tab_detail">
			                <div class="form-body">
			                    <div class="form-group ">
			                        ...
			                        <input class="form-control" id="title" placeholder="<?php echo lang('maximum_categories'); ?>" value="<?php if(isset($this->data['data']['title'])) echo $this->data['data']['title']; ?>" name="title" type="text">
			                    </div>
			                    <div class="form-group ">
			                    ...
			                    <div class="form-group ">
			                        ...
			                        <select name="vat" class="form-control" id="">
			                        	<option value="2">Đã có VAT</option>
			                        	<option value="1">Chưa có VAT</option>
			                    ...
			                    <div class="form-group ">
									...
									<div class="checkbox-list form-control height-auto">
										<label><div class="checker"><span><input type="checkbox" name="state" value="1"></span></div> Nổi bật</label>
										<label><div class="checker"><span><input type="checkbox" name="state" value="2"></span></div> Hàng sắp về</label>
										<label><div class="checker"><span><input type="checkbox" name="state" value="3"></span></div> Nhận đặt hàng</label>
										<label><div class="checker"><span><input type="checkbox" name="state" value="4"></span></div> Hàng cũ</label>
										<label><div class="checker"><span><input type="checkbox" name="state" value="5"></span></div> Hết hàng</label>
										<label><div class="checker"><span><input type="checkbox" name="state" value="6"></span></div> Khuyến mại</label>
									</div>
			                    </div>
			                    <div class="form-group ">
										        ...
										        <div class="form-control height-auto">
										            <div class="scrollbar">
										                <ul class="list-unstyled" id="list_brand">
										                    <li>
										                        <label><div class="checker"><span><input class="checkboxes" type="checkbox" name="brand" value="0"></span></div> Toyota</label>
										                    </li>
										                    <li>
										                        <label><div class="checker"><span><input class="checkboxes" type="checkbox" name="brand" value="1"></span></div> Yamaha</label>
										                    </li>
										                    <li>
										                        <label><div class="checker"><span><input class="checkboxes" type="checkbox" name="brand" value="2"></span></div> Honda</label>
										                    </li>
										                </ul>
										            </div>
										        </div>
								...
								<div class="portlet light bordered" id="block-image">
								    ...
								    <div class="portlet-body form">
								        ...
								        <input type="hidden" name="avatar" id="avatar" data-error="Bạn chưa chọn ảnh đại diện" value="">
