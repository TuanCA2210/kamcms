			                ...
			                <div class="form-body">
			                    ...
			                    <div class="form-group ">
			                        <div class="col-md-6 noPadding">
			                        	...
			                        	<input class="form-control" id="price" placeholder="<?php echo lang('sale_off'); ?>" value="<?php if(isset($this->data['data']['saleoff'])) echo $this->data['data']['saleoff']; ?>" name="saleoff" type="text" />
			                        </div>
			                        <div class="col-md-3">
