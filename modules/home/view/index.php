                                ...
                                <div>                        
                                    <div class="product-item">
                                      <div class="pi-img-wrapper">
                                        <img src="<?php echo base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.$_web['base_url_cdn'].$v['image'].'&h=259&w=194&zc=2';?>" class="img-responsive" alt="<?php echo $v['name'];?>">
                                        <div>
                    ...
                    <?php 
                        if (isset($content)) { 
                            foreach ($content as $k => $v) { 
                                ...
                                <div class="product-item">
                                  <div class="pi-img-wrapper">
                                    <img src="<?php echo base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.$_web['base_url_cdn'].$v['image'].'&h=550&w=600&zc=2';?>" class="img-responsive" alt="Berry Lace Dress">
                                    <div>
                                      <a href="<?php echo $_web['base_url_cdn'].$v['image'];?>" class="btn btn-default fancybox-button">Zoom</a>
                                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view" data-id="<?php echo $v['id'];?>">View</a>
                                    </div>
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="item active">
            <img src="<?php echo base_url().'tmp/public/';?>images/index-sliders/slide1.jpg" class="img-responsive" alt="Berry Lace Dress">
          </div>
          <div class="item">
            <img src="<?php echo base_url().'tmp/public/';?>images/index-sliders/slide2.jpg" class="img-responsive" alt="Berry Lace Dress">
          </div>
          <div class="item">
            <img src="<?php echo base_url().'tmp/public/';?>images/index-sliders/slide3.jpg" class="img-responsive" alt="Berry Lace Dress">
          </div>
        </div>
      </div>
    </div>
